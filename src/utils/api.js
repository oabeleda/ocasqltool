...
export const getHistoryFile = async () => await window.electronAPI.getHistoryFile()
export const saveHistoryFile = async (content) => await window.electronAPI.saveHistoryFile({ content })